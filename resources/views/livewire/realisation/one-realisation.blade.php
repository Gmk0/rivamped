            ...
            <div class="px-6 lg:w-9/12">
                ...
                <div class="col-lg-9 pe-lg-5">
                    <div class="post nopadding">
                        <img src="{{$post->getFirstMediaUrl('posts')}}" alt="" class="img-fluid border">
                        ...
                        <h2>{{$post->title}}</h2>
                        <div class="min-h-screen text-justify mt-4 mb-4 prose markdown lg:prose-xl">
                    ...
                    <div class="w-full bg-white rounded-lg  p-1 md:p-3 ">
                        <h3 class="font-semibold p-1 mb-4">Commentaires</h3>
                        ...
                        <div class=" flex justify-start  items-start px-3 my-3">
                            @auth
                                <div>
