<div class="min-h-sceen">
    ...
    <div class="flex items-center justify-start px-4">
        <x-bread-cumb :lien1="'Realisation'" />
    ...
    <div class="flex w-full px-6">
        <div class="min-h-screen lg:w-9/12">
            ...
            <section class="px-8 pb-4 hidden mt-8 not-format">
        ...
        <div class="hidden min-h-screen  bg-gray-50 px-4 border-gray-500 lg:flex-col lg:flex lg:w-3/12">
            ...
            <div>
                @foreach ($otherRealisation as $item)
                <div class="flex gap-2 mb-4">
                    ...
                    <div class="flex w-[60%] flex-col">
                        <a href="{{route('Realisation.one',[$item->slug])}}" class="text-xs block break-words">{{$item->title}}</a>
            ...
            <h1 class="p-4 text-lg text-center hidden">Tags de recherche</h1>
