    ...
    <div class="px-4">
        ...
        <div class="max-w-6xl py-4 mx-auto">
            ...
            <div data-aos="flip-down" class="max-w-screen-md mx-auto text-center">
                <p class="px-4 text-base text-gray-500">Avez-vous des questions ou souhaitez-vous en savoir plus sur
                    notre
                    organisation? N'hésitez pas à nous contacter</p>
            </div>

            <div class="flex flex-col px-6 my-8 lg:px-0 lg:flex-row">
                <div data-aos="fade-right" class="w-full px-4 lg:w-5/12">
                        ...
                        <form>
                            <div class="mb-6">
                                <input type="text" placeholder="Your Name"
                                    class="text-body-color border-[f0f0f0] focus:border-blue-600 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" />
                            </div>
                            <div class="mb-6">
                            ...
                            <div class="mb-6">
                                <textarea rows="6" placeholder="Your Message"
                                    class="text-body-color border-[f0f0f0] focus:border-blue-600 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"></textarea>
                            </div>
                            <div>
                                <button type="submit"
                                    class="w-full p-3 text-white transition bg-blue-600 border border-blue-600 rounded hover:bg-opacity-90">
                                    Send Message
                                </button>
                            </div>
                        </form>
