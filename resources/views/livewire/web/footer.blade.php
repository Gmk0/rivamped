        ...
        <div class="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
            <div class="lg:w-1/3">
                <a rel="noopener noreferrer" href="#" class="flex justify-center space-x-3 lg:justify-start">
                    ...
                    <span class="self-center text-2xl font-semibold">REVEMPED</span>
                </a>
            </div>
            <div class="grid grid-cols-2 px-4 text-sm lg:px-0 gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                <div class="space-y-3">
                    <h3 class="uppercase tracki dark:text-gray-50">Axes D'accompagnement</h3>
                    <ul class="space-y-1">
                        <li>
                ...
                <div class="space-y-3">
                    <h3 class="uppercase tracki dark:text-gray-50">Nous Soutenir</h3>
                    <ul class="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="{{route('don')}}">Faites un don</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="{{route('benevole')}}">Devenez Benevole</a>
                        </li>
                        <li>
                                <a rel="noopener noreferrer" href="{{route('partenarait')}}">Devenez Partenaire</a>
                            </li>
                    </ul>
                </div>
                <div class="space-y-3">
                    <h3 class="uppercase dark:text-gray-50">A propos</h3>
                    <ul class="space-y-1">
                        <li>
                            <a rel="noopener noreferrer" href="{{route('about')}}">A propos de nous</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="{{route('feedback')}}">Faq</a>
                        </li>
                        <li>
                            <a rel="noopener noreferrer" href="{{route('contact')}}">Contact</a>
                        </li>
                    </ul>
                </div>
                <div class="space-y-3">
