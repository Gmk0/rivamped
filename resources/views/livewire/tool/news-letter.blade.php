<div class="mt-4 bg-white border-t dark:bg-gray-900">
    <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
        <div class="max-w-screen-md mx-auto sm:text-center">
            ...
            <form wire:submit.prevent='subscrire'>
                <div class="items-center max-w-screen-sm mx-auto mb-3 space-y-4 sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input wire:model='email'
                            class="block w-full p-3 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg pl-9 sm:rounded-none sm:rounded-l-lg focus:ring-yellow-400 focus:border-yellow-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Enter your email" type="email" id="email" required="">
                    </div>
                    <div class="px-2">
                        <button type="button"
                            class="w-full px-5 py-3 text-sm font-medium text-center text-white bg-yellow-300 border border-yellow-400 rounded-lg cursor-pointer sm:rounded-none sm:rounded-r-lg hover:bg-yellow-00 4focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800">Subscribe</button>
                    </div>
                </div>
                <div
                    class="max-w-screen-sm mx-auto text-sm text-left text-gray-500 newsletter-form-footer dark:text-gray-300">
                    Nous attachons de l'importance à la protection de vos données. <a href="{{route('terms.show')}}"
